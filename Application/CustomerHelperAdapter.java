...
public class CustomerHelperAdapter extends RecyclerView.Adapter {
    List<CustomerFetchData> adminfetchDataList;

    public CustomerHelperAdapter(List<CustomerFetchData> adminfetchDataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        CustomerHelperAdapter.ViewHolderClass viewHolderClass=new CustomerHelperAdapter.ViewHolderClass(view);
...
/*          textView = itemView.findViewById( R.id.order_phone1 );
    ...
    */
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        CustomerFetchData adminfetchData = adminfetchDataList.get( position );
