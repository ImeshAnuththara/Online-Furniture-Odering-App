...
public class CustomerFetchData implements Serializable {
    ...
    public CustomerFetchData() {
    }

    public CustomerFetchData(String phone, String name, String address, String furnitureID, String furnitureName, String units, String totalPrice, String unitPrice) {
        this.phone = phone;
        this.name = name;
